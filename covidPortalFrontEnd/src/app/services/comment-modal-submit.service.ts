...
export class CommentModalSubmitService {
  ...
  public saveCommentUrl = AppSettings.BASE_URL + "/covidPortalApp/saveComment/";
  public fetchCommentsByLocationUrl = AppSettings.BASE_URL + "/covidPortalApp/fetchCommentsByLocation/";
