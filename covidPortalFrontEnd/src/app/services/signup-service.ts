...
export class SignupService {
    ...
    private signupUserUrl = this.BASE_URL+'/covidPortalApp/signupUser/';
    private checkUserUrl = this.BASE_URL+'/covidPortalApp/checkUser/';
    private checkEmailUrl = this.BASE_URL+'/covidPortalApp/checkEmail/';

    private apiTokenUrl = this.BASE_URL+'/covidPortalApp/api-token-auth/';
    private refreshTokenUrl = this.BASE_URL+'/covidPortalApp/api-token-refresh/';
    public token: string;
    public errors: any = [];
    public user: User;
