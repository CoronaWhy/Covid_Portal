...
export class ListDatafilesService {
    ...
    public getDatafilesUrl = AppSettings.BASE_URL + "/striatumPortalApp/listUploadedFiles/";
    public searchDatafilesUrl = AppSettings.BASE_URL + "/striatumPortalApp/searchUploadedFolders/";
    public deleteDatafileUrl = AppSettings.BASE_URL + "/striatumPortalApp/deleteDatafile/";
