...
export class ReportService {
    ...
    public getOverlayDataUrl =  AppSettings.BASE_URL + "/striatumPortalApp/getOverlayData/";
    public getFullScreenOverlayDataUrl =  AppSettings.BASE_URL + "/striatumPortalApp/getFullScreenOverlayData/";
    public fetchAllCommentsUrl = AppSettings.BASE_URL + "/striatumPortalApp/fetchAllComments/";
